...
class RemoteDeskMultiWindowManager {
  RemoteDeskMultiWindowManager._();

  static final instance = RemoteDeskMultiWindowManager._();
...
final rustDeskWinManager = RemoteDeskMultiWindowManager.instance;
