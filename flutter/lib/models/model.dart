...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsRemoteDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsRemoteDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsRemoteDeskVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get RemoteDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsRemoteDeskVirtualDisplays] ?? []);
  ...
  bool get isRemoteDeskIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'remotedesk_idd';
