<p align="center">
  ...
  <b>We need your help to translate this README, <a href="https://github.com/rustdesk/remotedesk/tree/master/src/lang">RemoteDesk UI</a> and <a href="https://github.com/rustdesk/doc.remotedesk.com">RemoteDesk Doc</a> to your native language</b>
</p>
...
Yet another remote desktop solution, written in Rust. Works out of the box with no configuration required. You have full control of your data, with no concerns about security. You can use our rendezvous/relay server, [set up your own](https://remotedesk.com/server), or [write your own rendezvous/relay server](https://github.com/rustdesk/remotedesk-server-demo).
...
Desktop versions use Flutter or Sciter (deprecated) for GUI, this tutorial is for Sciter only, since it is easier and more friendly to start. Check out our [CI](https://github.com/rustdesk/remotedesk/blob/master/.github/workflows/flutter-build.yml) for building Flutter version.
...
- **[libs/clipboard](https://github.com/rustdesk/remotedesk/tree/master/libs/clipboard)**: file copy and paste implementation for Windows, Linux, macOS.
- **[src/ui](https://github.com/rustdesk/remotedesk/tree/master/src/ui)**: obsolete Sciter UI (deprecated)
...
- **[flutter](https://github.com/rustdesk/remotedesk/tree/master/flutter)**: Flutter code for desktop and mobile
- **[flutter/web/js](https://github.com/rustdesk/remotedesk/tree/master/flutter/web/v1/js)**: JavaScript for Flutter web client
