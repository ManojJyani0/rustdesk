...
///
/// Note:
/// On linux, we use dbus to communicate multiple remotedesk process.
...
const DBUS_NAME: &str = "org.remotedesk.remotedesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "RemoteDesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.remotedesk.remotedesk /dbus org.remotedesk.remotedesk.NewConnection string:'PEER_ID'`
