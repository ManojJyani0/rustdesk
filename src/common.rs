...
#[inline]
pub fn is_remotedesk() -> bool {
    hbb_common::config::APP_NAME.read().unwrap().eq("RemoteDesk")
}
...
fn get_api_server_(api: String, custom: String) -> String {
    ...
    "https://admin.remotedesk.com".to_owned()
}

#[inline]
pub fn is_public(url: &str) -> bool {
    url.contains("remotedesk.com")
}
...
pub fn check_process(arg: &str, mut same_uid: bool) -> bool {
    ...
    for (_, p) in sys.processes().iter() {
        ...
        // on mac, p.cmd() get "/Applications/RemoteDesk.app/Contents/MacOS/RemoteDesk", "XPC_SERVICE_NAME=com.carriez.RemoteDesk_server"
...
pub type RemoteDeskInterval = ThrottledInterval;

#[inline]
pub fn remotedesk_interval(i: Interval) -> ThrottledInterval {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_RemoteDesk_interval() {
        ...
        for maker in base_intervals.into_iter() {
            ...
            let mut timer = remotedesk_interval(maker());
    ...
    #[allow(non_snake_case)]
    #[tokio::test]
    async fn test_RemoteDesk_interval_sleep() {
        let base_intervals = [interval_maker, interval_at_maker];
