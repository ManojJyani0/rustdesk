...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete RemoteDesk..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), RemoteDesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare RemoteDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a RemoteDesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a RemoteDesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a RemoteDesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [RemoteDesk Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep RemoteDesk background service", "Mantieni il servizio di RemoteDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione RemoteDesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show RemoteDesk", "Visualizza RemoteDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a RemoteDesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a RemoteDesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di RemoteDesk."),
        ...
        ("verify_remotedesk_password_tip", "Conferma password RemoteDesk"),
        ...
        ("Exit", "Esci da RemoteDesk"),
        ("Open", "Apri RemoteDesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare RemoteDesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_remotedesk_server_pro_to_{}_tip", "Aggiorna RemoteDesk Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di RemoteDesk come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da RemoteDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra RemoteDesk è aperta"),
        ...
        ("About RemoteDesk", "Info su RemoteDesk"),
        ...
        ("upgrade_remote_remotedesk_client_to_{}_tip", "Aggiorna il client RemoteDesk remoto alla versione {} o successiva!"),
