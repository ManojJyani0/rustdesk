...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke RemoteDesk..."),
        ...
        ("install_tip", "Karena UAC, RemoteDesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal RemoteDesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Agar bisa mengontrol Desktopmu dari jarak jauh, Kamu harus memberikan izin \"Aksesibilitas\" untuk RemoteDesk."),
        ("config_screen", "Agar bisa mengakses Desktopmu dari jarak jauh, kamu harus memberikan izin \"Perekaman Layar\" untuk RemoteDesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan RemoteDesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input RemoteDesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep RemoteDesk background service", "Pertahankan RemoteDesk berjalan pada service background"),
        ...
        ("Show RemoteDesk", "Tampilkan RemoteDesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada RemoteDesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada RemoteDesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC RemoteDesk yang sedang berjalan"),
        ...
        ("verify_remotedesk_password_tip", "Verifikasi Kata Sandi RemoteDesk"),
        ...
        ("scam_text1", "Jika anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan RemoteDesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_remotedesk_server_pro_to_{}_tip", "Silahkan perbarui RemoteDesk Server Pro ke versi {} atau yang lebih baru!"),
        ...
        ("selinux_tip", "pada perangkat anda, SELinux sedang aktif, yang mana itu dapat mencegah RemoteDesk berfungsi dengan baik sebagai sisi yang dikontrol."),
        ...
        ("powered_by_me", "Didukung oleh RemoteDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Koneksi hanya diperbolehkan jika jendela RemoteDesk sedang terbuka."),
        ...
        ("Floating window", ""),
        ("floating_window_tip", "Untuk menjaga layanan/service RemoteDesk agar tetap aktif"),
        ...
        ("About RemoteDesk", "Tentang RemoteDesk"),
        ...
        ("upgrade_remote_remotedesk_client_to_{}_tip", "Silahkan perbarui aplikasi RemoteDesk ke versi {} atau yang lebih baru pada komputer yang akan terhubung!"),
