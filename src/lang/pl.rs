...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "RemoteDesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować RemoteDesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić RemoteDesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić RemoteDesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [RemoteDesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep RemoteDesk background service", "Zachowaj usługę RemoteDesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji RemoteDesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show RemoteDesk", "Pokaż RemoteDesk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji RemoteDesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z RemoteDesk w Twojej sieci."),
        ...
        ("verify_remotedesk_password_tip", "Weryfikuj hasło RemoteDesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu RemoteDesk - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_remotedesk_server_pro_to_{}_tip", "Proszę zaktualizować RemoteDesk Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu RemoteDesk po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez RemoteDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno RemoteDesk jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę RemoteDesk w tle"),
        ...
        ("upgrade_remote_remotedesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient RemoteDesk do wersji {} lub nowszej!"),
