...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem RemoteDesk..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, RemoteDesk v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate RemoteDesku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate RemoteDesku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno RemoteDesku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »RemoteDesk Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep RemoteDesk background service", "Ohrani RemoteDeskovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije RemoteDesk, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "RemoteDesk potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "RemoteDesk potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_remotedesk_password_tip", "Preveri geslo za RemoteDesk"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite RemoteDesk, prekinite klic in program zaprite."),
        ("scam_text2", "RemoteDesk omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_remotedesk_server_pro_to_{}_tip", "Prosimo, nadgradite RemoteDesk Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo RemoteDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno RemoteDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri RemoteDesk storitvi v ozadju"),
        ...
        ("About RemoteDesk", "O RemoteDesku"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_remotedesk_client_to_{}_tip", "Prosimo, nadgradite RemoteDesk odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
