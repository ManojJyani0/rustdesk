...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة RemoteDesk..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. RemoteDesk قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت RemoteDesk في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح RemoteDesk اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح RemoteDesk اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ RemoteDesk باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [RemoteDesk Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep RemoteDesk background service", "ابق خدمة RemoteDesk تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق RemoteDesk, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show RemoteDesk", "عرض RemoteDesk"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من RemoteDesk اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح RemoteDesk اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في RemoteDesk الذي يعمل."),
        ...
        ("verify_remotedesk_password_tip", "تحقق من كلمة مرور RemoteDesk"),
        ...
        ("upgrade_remotedesk_server_pro_to_{}_tip", "ترقية خادم RemoteDesk Pro إلى {}"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع RemoteDesk"),
        ...
        ("About RemoteDesk", "حول RemoteDesk"),
        ...
        ("upgrade_remote_remotedesk_client_to_{}_tip", "ترقية عميل RemoteDesk البعيد إلى {}"),
