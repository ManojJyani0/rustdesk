...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "RemoteDeski võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa RemoteDesk mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et RemoteDesk oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb RemoteDeskile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb RemoteDeskile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma RemoteDeskile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [RemoteDesk Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep RemoteDesk background service", "Säilita RemoteDeski taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele RemoteDeski rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show RemoteDesk", "Kuva RemoteDesk"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma RemoteDeskile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma RemoteDeskile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud RemoteDeski kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_remotedesk_password_tip", "Kinnita RemoteDeski parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul RemoteDeski kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_remotedesk_server_pro_to_{}_tip", "Palun täienda RemoteDesk Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib RemoteDeskil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb RemoteDeskil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui RemoteDeski aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada RemoteDeski taustateenust."),
        ...
        ("About RemoteDesk", "RemoteDeski teave"),
        ...
        ("upgrade_remote_remotedesk_client_to_{}_tip", "Täiendage RemoteDeski klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
