<p align="center">
  <img src="../res/logo-header.svg" alt="RemoteDesk – vaše vzdálená plocha"><br>
  ...
  <b>Potřebujeme Vaši pomoc s překladem tohoto README, <a href="https://github.com/remotedesk/remotedesk/tree/master/src/lang">uživatelského rozhraní aplikace RemoteDesk</a> a <a href="https://github.com/remotedesk/doc.remotedesk.com">dokumentace k ní</a> do vašeho jazyka</b>
</p>

Popovídejte si s námi: [Discord](https://discord.gg/nDceKgxnkV) | [Twitter](https://twitter.com/remotedesk) | [Reddit](https://www.reddit.com/r/remotedesk) | [YouTube](https://www.youtube.com/@remotedesk)


[![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/I2I04VU09)

Zase další software pro přístup k ploše na dálku, naprogramovaný v jazyce Rust. Funguje hned tak, jak je – není třeba žádného nastavování. Svá data máte ve svých rukách, bez obav o zabezpečení. Je možné používat námi poskytovaný propojovací/předávací (relay) server, [vytvořit si svůj vlastní](https://remotedesk.com/server), nebo [si dokonce svůj vlastní naprogramovat](https://github.com/remotedesk/remotedesk-server-demo), budete-li chtít.

Projekt RemoteDesk vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak RemoteDesk funguje?**](https://github.com/remotedesk/remotedesk/wiki/How-does-RemoteDesk-work%3F)

[**STAHOVÁNÍ ZKOMPILOVANÝCH APLIKACÍ**](https://github.com/remotedesk/remotedesk/releases)
...
## [Sestavení ze zdrojových kódů](https://remotedesk.com/docs/en/dev/build/)
...
Ujistěte se, že tyto příkazy spouštíte z kořenového adresáře RemoteDesk, jinak aplikace nemusí být schopná nalézt potřebné prostředky (resources). Také si všimněte, že ostatní dílčí príkazy nástroje cargo, jako třeba `install` nebo `run` zatím nejsou prostřednictvím této metody podporovány, protože by vedly k instalaci či spuštění program uvnitř kontejneru namísto přímo v systému.

## Struktura souborů

- **[libs/hbb_common](https://github.com/remotedesk/remotedesk/tree/master/libs/hbb_common)**: kodek videa, nastavení, obalovaní tcp/udp, vyrovnávací paměť protokolu, funkce souborového systému pro přenos souborů a pár dalších podpůrných funkcí
- **[libs/scrap](https://github.com/remotedesk/remotedesk/tree/master/libs/scrap)**: zachytávání obsahu obrazovky
- **[libs/enigo](https://github.com/remotedesk/remotedesk/tree/master/libs/enigo)**: ovládání klávesnice/myši pro jednotlivé platformy
- **[src/ui](https://github.com/remotedesk/remotedesk/tree/master/src/ui)**: grafické uživatelské rozhraní
- **[src/server](https://github.com/remotedesk/remotedesk/tree/master/src/server)**: služby pro zvuk/schránku/zadávání/video a síťová spojení
- **[src/client.rs](https://github.com/remotedesk/remotedesk/tree/master/src/client.rs)**: spouští připojení k protějšku
- **[src/rendezvous_mediator.rs](https://github.com/remotedesk/remotedesk/tree/master/src/rendezvous_mediator.rs)**: komunikace s [remotedesk-server](https://github.com/remotedesk/remotedesk-server), očekávání vzdálených příméhých („proděrováváním“ TCP) nebo předávaných (relay) spojení
- **[src/platform](https://github.com/remotedesk/remotedesk/tree/master/src/platform)**: zdrojové kódy, specifické pro jednotlivé platformy
- **[flutter](https://github.com/remotedesk/remotedesk/tree/master/flutter)**: zdrojové kódy pro použití s aplikačním rámcem (framework) Flutter pro mobilní platformy
- **[flutter/web/js](https://github.com/remotedesk/remotedesk/tree/master/flutter/web/js)**: Javascript pro Flutter webový klient
